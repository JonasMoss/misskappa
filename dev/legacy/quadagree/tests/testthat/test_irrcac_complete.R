...
mod_quadagree_aggr <- kappa_aggr(x = x_aggr, values = 1:5, r = 6)
...
test_that("kappa_raw standard errors match irrCAC (with n-1 correction)", {
  ...
  se_quadagree_conger_raw <- mod_quadagree$conger$std_err
  ...
  se_quadagree_fleiss_raw <- mod_quadagree$fleiss$std_err
  ...
  se_quadagree_bp_raw <- mod_quadagree$bp$std_err
...
test_that("kappa_aggr standard errors match irrCAC (with n-1 correction)", {
  ...
  se_quadagree_fleiss_raw <- mod_quadagree_aggr$fleiss$std_err
  se_quadagree_fleiss_adj <- se_quadagree_fleiss_raw * sqrt(n_eff / (n_eff - 1))
  ...
  se_quadagree_bp_raw <- mod_quadagree_aggr$bp$std_err
  se_quadagree_bp_adj <- se_quadagree_bp_raw * sqrt(n_eff / (n_eff - 1))
