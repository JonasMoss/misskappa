...
Result<Estimation> estimate_gwise(
  ...
  auto pattern = detail::require_complete_tuple_observation(
      detail::observed_mask(ratings), g);
  if (!pattern.has_value()) return misskappa::unexpected(pattern.error());
