...
* Mention the key papers in missing data but do not dwell on it at all. Three sentences is enough. Should cite Tsiasis, van der Vaart, and Robins.
* Mention the definitions in the introduction and just cite Fleiss, Cohen, Brennan--Prediger and be done with it.
